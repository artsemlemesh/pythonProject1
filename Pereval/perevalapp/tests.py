...
class SubmitDataAPITests(APITestCase):
    def setUp(self):
        self.pereval_1 = PerevalAdd.objects.create(
            user_id=Users.objects.create(
        ...
        self.pereval_2 = PerevalAdd.objects.create(
            user_id=Users.objects.create(
    ...
    def test_list(self):
        ...
        pereval_object_1 = PerevalAdd.objects.filter(beauty_title='test BT').first()
        self.assertEqual(pereval_object_1.beauty_title, 'test BT')
        pereval_object_2 = PerevalAdd.objects.filter(beauty_title='test two BT').first()
